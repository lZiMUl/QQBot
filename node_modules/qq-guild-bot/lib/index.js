...
var OpenAPI = /*#__PURE__*/function () {
  ...
  _createClass(OpenAPI, [{
    ...
    value: function request(options) {
      ...
      resty__default["default"].useRes(function (result) {
        return result;
      }, function (error) {
      ...
      var client = resty__default["default"].create(options);
...
// 心跳参数
exports.OpCode = void 0; // 可使用的intents事件类型
...
exports.AvailableIntentsEventsEnum = void 0; // OpenAPI传过来的事件类型
...
})(exports.AvailableIntentsEventsEnum || (exports.AvailableIntentsEventsEnum = {}));

var WsEventType = {
  //  ======= GUILDS ======
  GUILD_CREATE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 频道创建
  GUILD_UPDATE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 频道更新
  GUILD_DELETE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 频道删除
  CHANNEL_CREATE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 子频道创建
  CHANNEL_UPDATE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 子频道更新
  CHANNEL_DELETE: exports.AvailableIntentsEventsEnum.GUILDS,
  // 子频道删除
  //  ======= GUILD_MEMBERS ======
  GUILD_MEMBER_ADD: exports.AvailableIntentsEventsEnum.GUILD_MEMBERS,
  // 频道成员加入
  GUILD_MEMBER_UPDATE: exports.AvailableIntentsEventsEnum.GUILD_MEMBERS,
  // 频道成员更新
  GUILD_MEMBER_REMOVE: exports.AvailableIntentsEventsEnum.GUILD_MEMBERS,
  // 频道成员移除
  //  ======= GUILD_MESSAGES ======
  MESSAGE_CREATE: exports.AvailableIntentsEventsEnum.GUILD_MESSAGES,
  // 机器人收到频道消息时触发
  MESSAGE_DELETE: exports.AvailableIntentsEventsEnum.GUILD_MESSAGES,
  // 删除（撤回）消息事件
  //  ======= GUILD_MESSAGE_REACTIONS ======
  MESSAGE_REACTION_ADD: exports.AvailableIntentsEventsEnum.GUILD_MESSAGE_REACTIONS,
  // 为消息添加表情表态
  MESSAGE_REACTION_REMOVE: exports.AvailableIntentsEventsEnum.GUILD_MESSAGE_REACTIONS,
  // 为消息删除表情表态
  //  ======= DIRECT_MESSAGE ======
  DIRECT_MESSAGE_CREATE: exports.AvailableIntentsEventsEnum.DIRECT_MESSAGE,
  // 当收到用户发给机器人的私信消息时
  DIRECT_MESSAGE_DELETE: exports.AvailableIntentsEventsEnum.DIRECT_MESSAGE,
  // 删除（撤回）消息事件
  //  ======= INTERACTION ======
  INTERACTION_CREATE: exports.AvailableIntentsEventsEnum.INTERACTION,
  // 互动事件创建时
  //  ======= MESSAGE_AUDIT ======
  MESSAGE_AUDIT_PASS: exports.AvailableIntentsEventsEnum.MESSAGE_AUDIT,
  // 消息审核通过
  MESSAGE_AUDIT_REJECT: exports.AvailableIntentsEventsEnum.MESSAGE_AUDIT,
  // 消息审核不通过
  //  ======= FORUMS_EVENT ======
  FORUM_THREAD_CREATE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户创建帖子时
  FORUM_THREAD_UPDATE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户更新帖子时
  FORUM_THREAD_DELETE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户删除帖子题时
  FORUM_POST_CREATE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户创建回帖时
  FORUM_POST_DELETE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户删除回帖时
  FORUM_REPLY_CREATE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户回复评论时
  FORUM_REPLY_DELETE: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户删除评论时
  FORUM_PUBLISH_AUDIT_RESULT: exports.AvailableIntentsEventsEnum.FORUMS_EVENT,
  // 当用户发表审核通过时
  //  ======= AUDIO_ACTION ======
  AUDIO_START: exports.AvailableIntentsEventsEnum.AUDIO_ACTION,
  // 音频开始播放
  AUDIO_FINISH: exports.AvailableIntentsEventsEnum.AUDIO_ACTION,
  // 音频结束播放
  AUDIO_ON_MIC: exports.AvailableIntentsEventsEnum.AUDIO_ACTION,
  // 机器人上麦
  AUDIO_OFF_MIC: exports.AvailableIntentsEventsEnum.AUDIO_ACTION,
  // 机器人下麦
  //  ======= PUBLIC_GUILD_MESSAGES ======
  AT_MESSAGE_CREATE: exports.AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES,
  // 机器人被@时触发
  PUBLIC_MESSAGE_DELETE: exports.AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES // 当频道的消息被删除时
...
exports.WebsocketCode = void 0; // websocket错误原因
...
})(exports.WebsocketCode || (exports.WebsocketCode = {}));
  ...
  _createClass(Ws, [{
    ...
    value: function createListening() {
      ...
      this.ws.on('message', function (data) {
        ...
        if ((wsRes === null || wsRes === void 0 ? void 0 : wsRes.op) === exports.OpCode.HELLO && wsRes !== null && wsRes !== void 0 && (_wsRes$d = wsRes.d) !== null && _wsRes$d !== void 0 && _wsRes$d.heartbeat_interval) {
          var _wsRes$d2;
        ...
        if (wsRes.op === exports.OpCode.HEARTBEAT_ACK || wsRes.t === SessionEvents.RESUMED) {
          if (!_this.alive) {
            _this.alive = true;
        ...
        if (wsRes.op === exports.OpCode.RECONNECT) {
          // 通知会话，当前已断线
          _this.event.emit(SessionEvents.EVENT_WS, {
        ...
        if (wsRes.op === exports.OpCode.DISPATCH) {
          // 更新心跳唯一值
          var _s = wsRes.s;
    ...
    value: function getValidIntentsType() {
      ...
      var defaultIntents = Object.keys(exports.AvailableIntentsEventsEnum); // 如果开发者没传intents，我们默认给他开启全部监听事件
...
var Session = /*#__PURE__*/function () {
  ...
  _createClass(Session, [{
    ...
    value: function createSession() {
      ...
      resty__default["default"].create(reqOptions).get(reqOptions.url, {}).then(function (r) {
        var wsData = r.data;
